...
class Camera : public Node {
 public:
  ...
  /* Spectral rendering */
  NODE_SOCKET_API(bool, use_custom_wavelength_importance);
  NODE_SOCKET_API_ARRAY(array<float3>, camera_response_function_curve);
  NODE_SOCKET_API_ARRAY(array<float>, wavelength_importance_curve);
