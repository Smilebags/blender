...
ccl_device_inline float4 rgb_ramp_lookup_new_name(
    ...
    KernelGlobals *kg, ShaderData *sd, float *stack, uint4 node, int *offset)
{
  ...
  float r = rgb_ramp_lookup_new_name(kg, *offset, relpos.x, true, true, table_size).x;
  float g = rgb_ramp_lookup_new_name(kg, *offset, relpos.y, true, true, table_size).y;
  float b = rgb_ramp_lookup_new_name(kg, *offset, relpos.z, true, true, table_size).z;
